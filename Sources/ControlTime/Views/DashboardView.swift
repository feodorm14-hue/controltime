...
struct ShortcutsGuideSheet: View {
    ...
    private var steps: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            step("2", "Выбери «Приложение» → выбери нужное приложение (TikTok, Instagram…)")
            step("3", "Отметь «При открытии» → «Далее»")
            step("4", "Нажми «Новая пустая автоматизация»")
            step("5", "Нажми «+» → в поиске введи «ControlTime»")
            step("6", "Выбери действие «Начать упражнение» — оно там уже есть автоматически!")
            step("7", "Сохрани и сними галку «Спрашивать перед запуском»")
        }
    }
